...
const english = "ABCDEFGHIJKLMNOPQRSTWVXYZabcdefghijklmnopqrstuvwxyz";
...
const alphabet = english + numbers + operators + katakana + hiragana;
...
window.addEventListener("click", () => {
  document.location.href = "https://martdafuq.github.io/terminal/";
});
